...
public class AnnotatedLoggingAspect {
    ...
    @Pointcut(value = "@annotation(com.github.flotskiy.FlotskiyBookShopApp.aspect.annotations.EntityCreationControllable)")
    ...
    @Pointcut(value = "@annotation(com.github.flotskiy.FlotskiyBookShopApp.aspect.annotations.EntityAccessControllable)")
