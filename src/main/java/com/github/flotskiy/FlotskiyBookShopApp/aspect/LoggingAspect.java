package com.github.flotskiy.FlotskiyBookShopApp.aspect;
...
public class LoggingAspect {
    ...
    @Before(value = "within(com.github.flotskiy.FlotskiyBookShopApp.*..*Service)")
    public void beforeServiceMethodFixingExecution(JoinPoint joinPoint) {
        logger.info("\u2B07\t STARTED: " + joinPoint.toShortString());
    }

    @Before(value = "within(com.github.flotskiy.FlotskiyBookShopApp.controllers.*..*Controller)")
    public void beforeControllerMethodFixingExecution(JoinPoint joinPoint) {
        logger.info("\u25B6\t STARTED: " + joinPoint.toShortString());
    }

    @Pointcut("execution(* com.github.flotskiy.FlotskiyBookShopApp.repository.*Repository.save(..))")
    ...
    @Pointcut("execution(* com.github.flotskiy.FlotskiyBookShopApp.repository.*Repository.delete*(..))")
