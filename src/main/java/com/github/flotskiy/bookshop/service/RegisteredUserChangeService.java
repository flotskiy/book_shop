...
import com.github.flotskiy.bookshop.exceptions.PasswordChangeException;
...
import com.github.flotskiy.bookshop.repository.VerificationTokenRepository;
...
public class RegisteredUserChangeService {
    ...
    public void changeAllUserData(VerificationTokenDto verificationTokenDto) {
        ...
        UserEntity currentUser = userEntityOptional.orElseThrow(EntityNotFoundException::new);
    ...
    public void createVerificationToken(ChangeUserDataConfirmPayload payload, UserDto userDto, String token) {
        ...
        VerificationTokenEntity verificationTokenEntity =
                createVerificationTokenEntity(payload, userEntity, emailTokenExpireMinutes);
