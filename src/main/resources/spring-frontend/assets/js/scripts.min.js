                        ...
                        postData('/requestContactConfirmation', data, function (result) {
                            if (result.result) {
                                ...
                                $row.find('.form-input[type="text"]').addClass('form-input_error')
                                    .after('<div class="form-error">That user already registered</div>');
                            }
                        })
                    });
                                ...
                                postData('/requestContactConfirmation', $this.data('send'), function (result) {
                                    if (result.result) {
                                        ...
                                        $thisStep.find('.form-input:not(.form-input_hide)[type="text"]')
                                            .addClass('form-input_error').after('<div class="form-error">' + result.error + '</div>');
                                    }
                                })
                            }
                        }
                                ...
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]')
                                                .addClass('form-input_error')
                                                .after('<div class="form-error">' + 'Пользователь не найден или неверный логин\/пароль!' + '</div>');
                                        }
                                    }
                                })
                            }
